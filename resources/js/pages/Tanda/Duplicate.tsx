...
import { ArrowLeft, Copy, Plus, Trash2, GripVertical, Shuffle } from 'lucide-react';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-bold text-gray-900">Duplicar Tanda</h1>
                        <p className="text-gray-600">Crea una nueva tanda basada en "{originalTanda.name}"</p>
                    </div>
                </div>
                ...
                <Card className="bg-blue-50 border-blue-200">
                    <CardHeader>
                        <CardTitle className="text-blue-800">Tanda Original</CardTitle>
                    ...
                    <CardContent>
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                            <div>
                                ...
                                <p className="text-blue-700">{originalTanda.name}</p>
                            </div>
                            <div>
                                <span className="font-medium text-blue-800">Monto:</span>
                                <p className="text-blue-700">${Number(originalTanda.amount).toFixed(2)}</p>
                            </div>
                            <div>
                                <span className="font-medium text-blue-800">Frecuencia:</span>
                                <p className="text-blue-700">{frequencyLabels[originalTanda.frequency]}</p>
                            </div>
                            <div>
                                <span className="font-medium text-blue-800">Participantes:</span>
                                <p className="text-blue-700">{originalTanda.participants.length}</p>
                            </div>
                            <div>
                                <span className="font-medium text-blue-800">Fecha de inicio original:</span>
                                <p className="text-blue-700">{new Date(originalTanda.start_date).toLocaleDateString()}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            <CardTitle>Nueva Tanda</CardTitle>
                            <CardDescription>
                        ...
                        <CardContent className="space-y-4">
                            ...
                            <div className="p-3 bg-blue-50 rounded-lg">
                                <p className="text-sm text-blue-800">
                                    <strong>💡 Información:</strong> Se generarán automáticamente {participants.length} pagos por participante.
